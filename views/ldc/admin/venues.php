      ...
      <?php if ($rooms !== false)
        ...
        <tr class="room">
          ...
          <td class="action">
            ...
            <span class="waves-effect spec-ajax" data-dest="<?php echo __url__.'/actions/ldc.actions.php' ?>" data-output=".modal-content" id="<?= $room['id'] ?>" data-query="roomdelete" data-fadeOut=".room"><i class="material-icons">delete</i></span>
          <div class="edit hide">
            <div class="row">
              <div class="col s12">
